...
public class PCSyncAccountExt implements ITableExt {
    ...
    private static final String PC_SYNC_ACCOUNT_COLOR = "-9206951";
    private static final String PC_SYNC_ACCOUNT_NAME = "letv@local";
    private static final String PC_SYNC_ACCOUNT_DISPLAY_NAME = "letv@local";
    private static final String PC_SYNC_ACCOUNT_OWNER_ACCOUNT = "letv@local";
